        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg sm:w-3/4 md:w-1/2 mx-auto">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div>
                        <h2 class="mb-3 text-center text-gray-700 font-bold">Edit Service</h2>
                        <form action="{{ route('managers.services.update', $service) }}" method="POST">
                            ...
                            <div class="mb-6">
                                ...
                                <input class="block shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="{{ $service->name }}" type="text" name="name" id="name">
                            ...
                            <div class="mb-6">
                                ...
                                <select class="block shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" name="duration" id="duration">
                                    ...
                                    @for($i = 1; $i <= 10; $i++)
                                        ...
                                        <option value="{{ $duration }}" @if($service->duration === $duration) {{ 'selected' }} @endif>{{ $duration }} minutes</option>
                            ...
                            <div class="mb-6">
                                ...
                                <input class="block shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="{{ $service->price }}" type="text" name="price" id="price">
